    ...
    <scroll-div class="content" scroll-y="true">
      ...
      <div v-for="img in imgData" class='list bannerStyle'>
        <div class='list-title'>
          <div class="text-moreDay">
            <text class="name"></text>
          </div>
        </div>
        <div class='imgList' data-id="test" data-type="test">
          <div>
            <image :data-id=img.code @click='jump' class="banner_image" :mode="aspectFill" :src=img.imgUrl data-type="imgUrls" data-img="test" data-index="0"></image>
          </div>
        </div>
      ...
      <ad class="list bannerStyle" unit-id="adunit-b715e0ea80c4657b"></ad>
    </scroll-div>
  </div>
</template>
...
<style scoped>
  ...
  .party_info_left_bottom_month_text {
    color: #fe5300;
    width: 50%;
    text-align: right;
    font-size: 16px;
  ...
  .party_info_right_bottom_count_text {
    width: 100%;
    padding-left: 50rpx;
    margin-top: 20rpx;
    color: #fe5300;
  ...
  .record_query_content_avatar {
    width: 12px;
    height: 12px;
    margin-right: 15rpx;
  }

  .record_query_content_text {
    font-size: 15px;
    color: #717171;
  }
  ...
  .banner swiper-item:nth-of-type(2) image {
    margin-left: 2rpx;
  }
  ...
  .item {
    width: 710rpx;
    /* border-radius: 15rpx; *//* box-shadow: 0 5rpx 30rpx #ccc; */
    margin: 0 auto 20rpx;
  ...
  .hotStyle scroll-view view text:nth-child(1) {
    font-size: 30rpx;
    font-weight: bold;
  }

  .hotStyle scroll-view view text:nth-child(2) {
    font-size: 24rpx;
  }

  .hotStyle scroll-view view.hotActive text {
    color: #e2211c;
  }

  .hotStyle scroll-view view.hotActive::before {
    content: '';
    width: 134rpx;
    height: 3rpx;
    background: #e2211c;
  ...
  .hotStyle scroll-view view:nth-child(2) {
    border-left: 1rpx solid #dedddc;
    border-right: 1rpx solid #dedddc;
    box-sizing: border-box;
  }

  .hotStyle .hotGoods .hotGoodsList {
    display: flex;
    width: 710rpx;
    height: 320rpx;
    margin: 20rpx 0;
  ...
  .hotDetail view:nth-child(3) {
    color: #341b1c;
    font-size: 24rpx;
  }

  .hotDetail view:nth-child(3) text {
    font-size: 36rpx;
    color: #e2211c;
  }

  .hotDetail view:nth-child(4) {
    color: #341b1c;
    font-size: 24rpx;
  }

  .hotDetail view:nth-child(4) text {
    font-size: 36rpx;
    color: #e2211c;
  }

  .hotDetail view:nth-child(5) {
    color: #969ba9;
    font-size: 24rpx;
    margin-top: 10rpx;
  }

  .hotDetail view:nth-child(5) text {
  ...
  .hotGoodsList .hotBuy {
    ...
    line-height: 55rpx;
    text-align: center;
    background: linear-gradient(to right, #fe6b55, #e2211c);
    border-radius: 15rpx;
    position: absolute;
    right: 20rpx;
    bottom: 20rpx;
  ...
  .newCoupon .info text:first-child {
    margin-bottom: 10rpx;
  }
