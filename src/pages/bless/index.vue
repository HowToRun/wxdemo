<template>
  <div class="container">
    ...
    <div class="friends">
      <div v-for="item in blessDataAll" @click='loadMoreFriends' class="face">
        <image :src=item.avatarUrl></image>
      </div>
    </div>
    <div class="btn_zone">
      <div class="fl,show">
        <button class='zan' @click='zan'>送上祝福</button>
      </div>
      <div class="share fr,show">
    ...
    <div v-for="item in commentData" class="chat_div">
      <div class="chat_list">
        <div class="chat_face">
          <image :src=item.avatarUrl></image>
        </div>
        <div class="chat_words">
          <div class="chat_meta">
    ...
    <div class="send_msg,show">
      <form>
        <input placeholder="在这里输入您要说的话" class="send_ipt" v-model="inputValue" />
        <button @click="foo" class="send_btn">发布</button>
      </form>
    </div>
